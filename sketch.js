...
function setup() 
{
  ...
  bunny = createSprite(120,windowHeight-80,100,100);
  bunny.scale = 0.2;
  ...
  starCount=createSprite(50,50,10,10)
  starCount.addAnimation('empty',empty)
  starCount.addAnimation('one',one)
  starCount.addAnimation('2star',two)
